...
//   const usernameFilter = router.query.username || "";
//   const statusFilter = router.query.status || "";
//   const [localUsername, setLocalUsername] = useState(usernameFilter); // Added localUsername state
...
//   const filteredUsers = users.filter(
//     (user) =>
//       user.username.toLowerCase().includes(localUsername.toLowerCase()) && // Use localUsername for real-time filtering
//       (statusFilter === "" || user.active.toString() === statusFilter)
//   );
...
//             type="text"
//             placeholder="Filter by username..."
//             value={localUsername} // Use localUsername state
//             onChange={handleUsernameChange} // Update localUsername state
//             onKeyPress={handleUsernameKeyPress} // Update filters on Enter key press
//             className="px-4 py-2 border rounded mb-2 sm:mb-0 w-full sm:w-auto sm:flex-grow mr-2"
//           />
//           <select
//             className="px-4 py-2 border rounded w-full sm:w-48"
...
//   const usernameFilter = router.query.username || "";
//   const statusFilter = router.query.status || "";
//   const [localUsername, setLocalUsername] = useState(usernameFilter);
